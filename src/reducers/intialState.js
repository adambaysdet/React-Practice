const initState = {
    posts: [
      ...
      {id: '4', title: 'Abdurrahman Bayraktar', body: 'Lorem ipsum, dolor sit ameg elit. Consequatur voluptate laborum perferendis, Abdurrahman'},
      {id: '5', title: 'Ekrem Bayraktar', body: 'Lorem ipsum, dolor sit ameg elit. Consequatur voluptate laborum perferendis, Ekrem Bayraktar'} 
    ],
    // user :[
    //   {id:1, name:'Abdurrahman', age:43},
    //   {id:2, name:'Cigdem', age:40},
    //   {id:3, name:'Ekrem', age:12},
    //   {id:4, name:'Nilufer', age:7}
    // ]
  }
